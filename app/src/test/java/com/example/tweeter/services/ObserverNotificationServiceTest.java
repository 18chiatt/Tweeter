...
import com.example.tweeter.presenter.ObserverNotificationPresenterTest;
...
public class ObserverNotificationServiceTest {

    ObserverNotificationService toUse;
    ServerFake server;
    User user;
    ...
    @Before
    public void setup(){
        this.toUse = new ObserverNotificationService();
